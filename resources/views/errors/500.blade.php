...
<head>
    ...
    <title>500 — Chyba serveru | ŽďárAI</title>
...
<body class="bg-gray-950 text-gray-100 font-mono antialiased min-h-screen flex items-center justify-center px-4">
    <div class="text-center">
        <!-- Velký kód chyby -->
        <p class="text-green-400 text-8xl md:text-9xl font-bold tracking-tighter select-none">500</p>
        ...
        <!-- Popis -->
        <h1 class="text-xl md:text-2xl font-semibold text-gray-100 mb-2">Chyba serveru</h1>
        <p class="text-gray-500 text-sm mb-8 max-w-sm mx-auto leading-relaxed">
            Na serveru došlo k neočekávané chybě. Zkus to prosím za chvíli znovu.
        </p>
